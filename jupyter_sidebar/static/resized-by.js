...
(function(factory, undefined) {
  ...
  if ($.fn.resizedBy) return;

  $.fn.resizedBy = function fnResizable(options) {
    var opt = {
      ...
      // check the called value every time a drag begins
      enable: () => true
    };
    ...
    return this.each(function() {
      ...
      $el.addClass('resizedBy');
      $handle.bind('mousedown.rsz touchstart.rsz', e => opt.enable(e) && startDragging(e));
